...
class ContextualGAMClassifier(ContextualizedClassifier):
    """
    The Contextual GAM Classifier separates and interprets the effect of context in context-varying decisions and classifiers, such as
    heterogeneous disease diagnoses.
...
class ContextualGAMRegressor(ContextualizedRegressor):
    """
    The Contextual GAM Regressor separates and interprets the effect of context in context-varying relationships, such as heterogeneous
    treatment effects.
